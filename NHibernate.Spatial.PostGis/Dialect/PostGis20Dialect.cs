...
namespace NHibernate.Spatial.Dialect
{
    ...
    /// 
    /// </summary>
    public class PostGis20Dialect : PostgreSQL82Dialect, ISpatialDialect
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostGis20Dialect"/> class.
        /// </summary>
        public PostGis20Dialect()
        {
        ...
        public string GetSpatialCreateString(string schema)
        {
            ...
            string script = string.Format(@"
                ...
                SELECT {0}NHSP_CreateIntersectionAggregate();",
                QuoteSchema(schema),
                IntersectionAggregateName,
                SpatialDialect.IsoPrefix);
